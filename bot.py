...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # --- المساعد الذكي (تم تقليل التعقيد ليعمل كما كان سابقاً) ---
        ...
        try:
            ...
            await update.message.reply_text("حدث خطأ في الاتصال، تأكد من مفتاح الـ API في إعدادات Railway.")
